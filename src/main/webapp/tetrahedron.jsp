...
<div>
    <br>
    <h3>Тетраэдр</h3>
    <form action="figure?f=тетраэдр" method="post">
        <p>Введите длину стороны в метрах:</p>
        ...
        <input type="number" min="0" max="4" value="2" id="amount" name="amount" placeholder="точность "><br>
        <br><output name="out" >Длина стороны: ${len}м <br>
        Объем тетраэдра: ${volume} м3</output>
