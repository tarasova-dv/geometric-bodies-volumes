...
<div>
    <br>
    <h3>Конус</h3>
    <form action="figure?f=конус" method="post">
        <p>Введите радиус конуса в метрах:</p>
        <input type="number" step="any" min="0" value="0" id="radius" name="radius" placeholder="радиус">
        <p>Введите высоту конуса в метрах:</p>
        ...
        <br><output name="out" >Радиус конуса: ${rad}м
        <br> Высота конуса: ${h}м
        <br> Объем конуса: ${volume} м3</output>
